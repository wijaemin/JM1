...
check(regexp_like(member_contact,'^01[016789][1-9][0-9]{3}[0-9]{4}$')),
member_level varchar2(9) default '일반'
...
values('minialp2002','Jm720613!!','위재민','2002-05-13','01028645063');
